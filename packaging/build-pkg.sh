...
cp "$ROOT/packages_rdma_rh7.json" "$STAGE/packages_rdma_rh7.json"
...
build_deb() {
    ...
    cp "$STAGE/packages_rdma_rh7.json" "$deb_root/$deb_name/usr/lib/koet/"
    ...
    chmod 0644 "$deb_root/$deb_name/usr/lib/koet/packages_rdma_rh7.json"
